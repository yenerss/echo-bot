      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<:no:1249336451590651924> Nothing Playing yet", ephemeral: true})
...
/**
* @INFO
* Bot Coded by yener5855#6186 | https://github?.com/yener5855/discord-js-lavalink-Music-Bot-erela-js
* @INFO
