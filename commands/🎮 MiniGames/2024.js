...
class TwoZeroFourEight {
  ...
  async startGame() {
    ...
    const up = new MessageButton().setEmoji(⏫).setStyle('PRIMARY').setCustomId('2048_up')
    const left = new MessageButton().setEmoji(⬅️).setStyle('PRIMARY').setCustomId('2048_left')
    const down = new MessageButton().setEmoji(⏬).setStyle('PRIMARY').setCustomId('2048_down')
    const right = new MessageButton().setEmoji(➡️).setStyle('PRIMARY').setCustomId('2048_right')
