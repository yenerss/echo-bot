...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let yenerdc = client.guilds.cache.get("773668217163218944")
      let yenermembers = await yenerdc.members.fetch().catch(() => {});
      let partnercount = yenermembers.filter(m => m.roles.cache.has("823150244509515807"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.com/invite/Yfb2fnkduE")
