...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Invite Public Bot').setURL("https://discord.com/invite/Yfb2fnkduE")
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.com/invite/Yfb2fnkduE")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('Clan Bot | powered by yener.eu', 'https://imgur.com/jPItIw0.gif')
