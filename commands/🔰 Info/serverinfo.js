...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<:arrow:1249336173734924389> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:no:1249336451590651924> \`No Channel\`"}`, true)
      embed.addField("**<:arrow:1249336173734924389> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:no:1249336451590651924> \`No Channel\`"}`, true)
      embed.addField("**<:arrow:1249336173734924389> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:no:1249336451590651924> \`No Channel\`"}`, true)

      embed.addField("**<:arrow:1249336173734924389> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:arrow:1249336173734924389> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:arrow:1249336173734924389> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<:arrow:1249336173734924389> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:no:1249336451590651924> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:arrow:1249336173734924389> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:arrow:1249336173734924389> SERVER DISCOVERY SPLASH:**`)
