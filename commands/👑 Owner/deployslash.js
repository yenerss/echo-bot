    ...
    if (message.author.id != "809533218205466674")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only yener is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.com/invite/Yfb2fnkduE), open a Ticket and ask for it!`)
        ]
      });
    try {
