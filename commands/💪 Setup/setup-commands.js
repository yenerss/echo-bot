  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      collector.on("collect", async b => {
        ...
        b?.reply(`<a:yes:1249336349761339454> **\`Enabled ${enabled} Command-Categories\` and \`Disabled ${disabled} Command-Categories\` out of \`${b?.values.length} selected Command-Categories\`**`)
      })
