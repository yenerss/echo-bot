...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:no:1249336451590651924> **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:no:1249336451590651924> **You need to be the Owner of this Server!**`)
      }
        ...
        let menuoptions = [
          {
            ...
            emoji: !client.settings.get(message.guild.id, "autobackup") ? "1249336349761339454" : "1249336451590651924"
          },
          {
            value: "Cancel",
