...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    //only allow the Server owner, (&yener) to execute this Command, (yener just because if he needs to help for Shop Bots)
    if(message.author.id != message.guild.ownerId){
      if(message.author.id != "809533218205466674")
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.com/invite/Yfb2fnkduE')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<a:yes:1249336349761339454> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.com/invite/Yfb2fnkduE')
              ...
              menuoptions = [
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "1249336451590651924": "1249336349761339454"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "1249336451590651924": "1249336349761339454"
                },
                {
                ...
                if(String(index) == "0"){
                   ...
                   */
                    ...
                    async function first_layer(){
                      menuoptions = [
                        {
                          ...
                          emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "1249336451590651924": "1249336349761339454"
                        },
                        {
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.com/invite/Yfb2fnkduE')
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<:no:1249336451590651924> You already selected something, this Selection is now disabled!`, ephemeral: true})
            ...
            return menu?.reply({content: "<a:yes:1249336349761339454> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
            ...
            for(const ch of channels.map(this_Code_is_by_yener_6966 => this_Code_is_by_yener_6966)){
              try {
                if(ch) {
