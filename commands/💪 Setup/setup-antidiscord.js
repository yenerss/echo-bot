        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antidiscord.enabled`) ? "1249336451590651924" : "1249336349761339454"}`
          },
          {
            value: "Settings",
