  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:1249336173734924389> **Name**', json.name, true)
        .addField("<:arrow:1249336173734924389> **Hex**", json.hex, true)
        .addField("<:arrow:1249336173734924389> **RGB**", json.rgb, true)
        .addField(`<:arrow:1249336173734924389> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
